// 4T-000193: window.api-Stub fuer Renderer-Modul-Unit-Tests (jsdom).
...
window.api = {
  ...
  // 4T-000204: Top-Level-Listener und Pipeline-Konfiguration der
  // Task-Status-Verwaltung (app-init.js / task-states.js).
  onTaskStatesChanged: noop,
  configureTaskStates: noop,
  // 4T-000284: Pipeline-Konfiguration der Frontmatter-Anzeige
  ...
  // 4T-000292: Erweiterungs-Lebenszyklus (extension-lifecycle.js spiegelt
  ...
  // 4T-000498 (Epic 3E-000090): Pipeline-Konfiguration der Task-Marker
  // (tasks.js spiegelt Global Filter und Labels in die Preload-Pipeline).
  configureTaskMarkers: noop,
  // 4T-000279: Entwurfs-Aufbau der Einstellungs-Seite liest den Store
  // (readAppearanceFromStore) und persistiert bei Anwenden.
  getSetting: async () => undefined,
  setSetting: async () => {},
  // 4T-000582 (Epic 3E-000107): Der Einstellungs-Bereich Rechtschreibprüfung liest
