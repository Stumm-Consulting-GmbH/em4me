// 4T-000213 (Epic 3E-000042): Seiten-Registry des Handbuchs.
//
// CJS wie src/shared/commands/commands.js, damit Main (Whitelist des IPC-Seiten-
...
const MANUAL_PAGES = [
  ...
  // 4T-001078 (Epic 3E-000194): Nutzen-Seite — Arbeitsformen und Markdown-Umfang
  ...
  // 4T-000212: generierte Seiten — Funktions-Tabelle aus HELP_FEATURE_GROUPS
  ...
  // 4T-000214: Themen-Seiten (gebuendelt, eine Datei pro Sprache).
  { id: 'markdown-basics', titleKey: 'manual.page.markdownBasics.title', source: 'bundled' },
  // 4T-000380 (Epic 3E-000071): Editor-Kontextmenue (Rechtsklick) — Aufbau,
  ...
  // 4T-000609 (Epic 3E-000114): Format-Toolbar (Sichtbarkeit im Edit-Modus,
  ...
  // 4T-000529 (Epic 3E-000095): Erinnerungen (⏰-Melde-Marker auf Aufgaben,
  ...
  // 4T-000792 (Epic 3E-000125): Anlagen (Einfuegen und Ziehen, Ablage-Ort samt
  ...
  // 4T-000342 (Epic 3E-000061): Unterseiten (U+2215-Namens-Konvention,
  ...
  // 4T-001294 (Epic 3E-000224): Teilung großer Dokumente. Steht unmittelbar hinter
  ...
  // 4T-000457 (Epic 3E-000084): Graphenansicht (Bereichs-Graph-Tab und Datei-
  ...
  // 4T-000451 (Epic 3E-000083): Eigenschafts-Profile (Profil-Dateien mit
  ...
  // 4T-000356 (Epic 3E-000065): Frontmatter-Abfrage (perspective-query-Fence,
  ...
  // 4T-000415 (Epic 3E-000078): Skript-Bloecke (perspective-script-Fence,
  // Sandbox, Vertrauensmodell, pq-API-Referenz mit Beispielen).
  { id: 'scripts', titleKey: 'manual.page.scripts.title', source: 'bundled' },
  // 4T-000429 (Epic 3E-000080): Vorlagen (Vorlagen-Ordner mit Bereichs-
  ...
  // 4T-000437 (Epic 3E-000081): Journale (Regale und Granularitaeten, Ordner-/
  ...
  // 4T-000892 (Epic 3E-000168, Befund L-09): Ansichten und Darstellung — die vier
  ...
  // 4T-001050 (Epic 3E-000151): Mindmap-Ansicht (fuenfter Ansichts-Modus, Lage der
  ...
  // 4T-000467 (Epic 3E-000086): Farbschemas (Slot-Modell, Pflege, Modus-Zuordnung,
  // Kontrast-Grenzen).
  ...
  // 4T-000334 (Epic 3E-000060): Dokument-Historie (Markdown-Data-Begleitdatei,
  ...
  // 4T-000360 (Epic 3E-000066): Dokument-Notizen (eine Notiz je Dokument in der
  ...
  // 4T-000366 (Epic 3E-000067): Block-Eigenschaften (Metadaten pro Block-Anker in
  ...
  // 4T-000523 (Epic 3E-000094): Kommando-Platzierung (eigene Statusbar-Buttons
  ...
  // 4T-000547 (Epic 3E-000097): Kalender-Systeme (Bloecke mit parallelen
