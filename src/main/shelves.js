...
// prozess-neutral in src/shared/shelf-core.js und bleibt unangetastet; hier
...
// an echten Temp-Ordnern unit-testbar sind (Muster src/main/books.js);
...
const { readBookFileName, readChapterTree, flattenChapters } = require('../shared/book-core.js');
