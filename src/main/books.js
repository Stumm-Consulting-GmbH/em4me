...
// src/shared/book-core.js und bleibt unangetastet; hier kommt allein der
...
// unit-testbar sind (Muster src/main/demo-area.js); main.js verdrahtet sie
...
const { sanitizeNewFileName, isInsideArea, isSamePath } = require('./area-path.js');
