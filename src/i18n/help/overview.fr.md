...
- [Profils de propriétés](property-profiles.md) — définitions de champs centralisées avec type, plage de valeurs et valeur par défaut : fichiers de profil, association par champ, étiquette et dossier, profil standard, héritage entre profils, réservoirs de valeurs par note et requête, symbole du profil sur le document, effet dans les deux éditeurs de propriétés.
