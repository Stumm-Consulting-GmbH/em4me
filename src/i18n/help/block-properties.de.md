...
Gelten für das Dokument **Eigenschafts-Profile**, so erben seine Blöcke deren Definitionen: Ein definiertes Feld trägt hier denselben Typ, dieselben Auswahl-Werte und dieselbe Kennzeichnung wie im Panel des Dokuments. Auch strukturierte Felder (Objekt und Objekt-Liste) lassen sich am Absatz bedienen; sie werden in der Begleitdatei gespeichert. **Ein solcher verschachtelter Wert erscheint allerdings nicht im Bereichs-Index** und lässt sich deshalb in einer Block-Abfrage nicht als Bedingung nutzen — anders als die einfachen Werte. Abgeleitete Felder erscheinen auch hier, mit ihrem gerechneten Wert und nicht bearbeitbar; sie stehen nie in der Begleitdatei.
