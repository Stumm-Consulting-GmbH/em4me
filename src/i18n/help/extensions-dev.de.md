...
Die Erweiterungs-API trägt eine eigene, semantische Versionsnummer. Ein Paket deklariert in `apiVersion`, gegen welche API-Version es gebaut ist. Kompatibel ist es, wenn die Major-Version mit der App übereinstimmt und die deklarierte Minor-Version nicht neuer ist als die der App. Inkompatible Pakete werden nie geladen und im Einstellungs-Bereich mit klarer Meldung gelistet.
...
Als lauffähige Vorlage dient die Referenz-Erweiterung `beispiel` mit allen Beitrags-Arten dieser Seite; ihr Aufbau entspricht exakt den Beispielen oben.
