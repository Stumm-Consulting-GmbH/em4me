...
import { parseTaskLine, stripGlobalFilter, primaryDateField } from '../../shared/task-markers.js';
import { taskMarkerBadgeSpec, getTaskMarkersConfig } from '../../shared/markdown/plugins.js';

// Bekannte Syntaxfehler-Codes des Parsers (src/shared/perspective-query.js) auf
...
const SYNTAX_ERROR_KEYS = {
  ...
  // 4T-0402 (Epic 3E-0076): Funktions-Validierung (perspective-query-eval.js)
  // laeuft ueber denselben queryError-Pfad wie die Parser-Codes.
