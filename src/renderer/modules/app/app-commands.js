...
// Handler.
//
// Auszug aus app-init.js, 4T-001001 (Epic 3E-000196). Die Tabelle bleibt als
...
// 4T-001176 (Epic 3E-000220): Abfrage zu einem Profil einfuegen.
...
// --- Kommando-Dispatcher (4T-000207, Epic 3E-000015) ------------------------------
...
// 4T-000207: Auto-Save-Toggle — gemeinsamer Pfad fuer Menue-IPC und Kommando
...
// 4T-000207: Sitzungs-Restore-Toggle — gemeinsamer Pfad wie oben.
/**
...
// 4T-000486 (Epic 3E-000091): gemeinsamer Pfad der drei Picker-Kommandos.
...
export const commandHandlers = {
  ...
  // 4T-000322 (Epic 3E-000058): Bereich oeffnen/schliessen (Main fuehrt aus).
  'area.open': () => {
    api.openArea();
  },
  'area.close': () => {
  ...
  // 4T-000632 (Epic 3E-000102): Demo-Area erstellen (Main fuehrt aus).
  // 4T-000843 (Epic 3E-000147): Buch oeffnen/anlegen/schliessen (Main fuehrt aus).
  'book.open': () => {
  ...
  // 4T-000867 (Epic 3E-000162): Buecherregal oeffnen/anlegen/schliessen (Main
  ...
  // 4T-000846 (Story 4S-000755): Leseführung über Kapitel-Grenzen — der
  ...
  // 4T-000847 (Story 4S-000756): Datei des gerade gelesenen Kapitels physisch
  ...
  // 4T-000538 (Epic 3E-000098): Arbeitsbereichs-Lebenszyklus (Dialoge im
  ...
  // 4T-000426 (Epic 3E-000080): neue Datei aus Vorlage (Auswahl-Popup und
  // Platzhalter-Dialoge; Abbruch erzeugt keine Datei).
  'file.newFromTemplate': () => {
    newFileFromTemplate();
  },
  // 4T-000426: Vorlage an der Cursor-Position einfuegen (Guards und
  ...
  // 4T-001176 (Epic 3E-000220, E7): Abfrage zu einem Profil einfuegen.
  ...
  // 4T-000774 (Epic 3E-000128): aktive Unterseite von ihrer uebergeordneten Seite
  ...
  // 4T-000303 (Epic 3E-000054): PDF-Export des gerenderten Inhalts. Der
  ...
  'app.openSettings': () => {
    // 4T-000277: oeffnet die Einstellungs-Seite (Tab) statt des Modals.
    openSettingsPage();
  },
  'view.modeRendered': () => {
  ...
  // 4T-001047 (Epic 3E-000151): Bei ausgeschalteter Erweiterung filtert der
  ...
  // ansprechbar ist (4T-000014/4T-000015/4T-000073). Seit 4T-000207 deckt der
  ...
  // 4T-001174 (Epic 3E-000220): Feld-Formular des Dokuments oeffnen.
  'view.openFieldForm': () => {
    void oeffneFeldFormular(state.activePaneIndex);
  },
  // 4T-000359 (Epic 3E-000066): Notizen-Sektion toggeln.
  'view.toggleNotes': () => {
  ...
  // 4T-000341 (Epic 3E-000061): Unterseiten-Sektion toggeln.
  'view.toggleSubpages': () => {
    toggleSubpagesPanel(state.activePaneIndex);
  },
  // 4T-000456 (Epic 3E-000084): Datei-Graph-Sektion toggeln.
  'view.toggleGraphPanel': () => {
    toggleFileGraphPanel(state.activePaneIndex);
  },
  // 4T-000527 (Epic 3E-000095): Erinnerungs-Sektion toggeln.
  'view.toggleReminders': () => {
    toggleRemindersPanel(state.activePaneIndex);
  },
  // 4T-000567 (Epic 3E-000104): Bereichs- und Kalender-Panel toggeln
  ...
  // 4T-000372 (Epic 3E-000069): Uhr-Sektion toggeln.
  'view.toggleClock': () => {
  ...
  // 4T-000697 (Epic 3E-000141): linke/rechte Sidebar-Spalte der aktiven Pane-
  ...
  // 4T-000207 (Epic 3E-000015): Lokalzeit-Timestamp 'yyyy-mm-dd hh:mm' an der
  ...
  'edit.insertTimestamp': () => {
    // 4T-000398 (Epic 3E-000066): fokussierter Editor — das Notiz-Feld hat Vorrang,
  ...
  // 4T-000486 (Epic 3E-000091): Datums-/Uhrzeit-Picker — gleiche Editor-
  ...
  // 4T-000528 (Epic 3E-000095): Erinnerung setzen (Picker auf der Checkbox-
  // Zeile; Editor-Aufloesung und Guards im Modul).
  'task.setReminder': () => {
    void runSetReminderCommand();
  },
  // 4T-000216 (Epic 3E-000042): F1 bzw. Hilfe -> Hilfe oeffnet die Handbuch-
  // Ueberblicksseite (das fruehere Modal ist vollstaendig zurueckgebaut).
  'help.open': () => {
    openManualPage('overview');
  },
  // 4T-000644 (Epic 3E-000127): geführte Produkt-Tour. Der Eintrag hier ist der
  ...
  // 4T-000620 (Epic 3E-000117): Bereichs-Statistik. Der Eintrag hier ist der
...
// plus Overrides gebaut; 4T-000208 baut sie bei hotkeys:changed neu.
...
export function rebuildHotkeyDispatchMap() {
  ...
  // 4T-000292: Kommandos effektiv deaktivierter Erweiterungen verlieren ihr
...
// Tastenkürzel — zentraler Kommando-Dispatcher (4T-000207, Epic 3E-000015).
...
// aus 4T-000017. Die Escape-Kaskade und die Nicht-Registry-Bindings
