...
// src/shared/clock-options.js (unit-testbar ohne DOM).
'use strict';
...
import { persistSetting, updateEmptyState } from './views.js';
import { attachExtensionRuntime, isExtensionActive } from './extension-lifecycle.js';
import {
  CLOCK_MODES,
  CLOCK_OPTIONS_KEY,
  analogSizePx,
