...
// 4T-000982 (Epic 3E-000196): aus live-deco.js herausgelöst. Alle Aufrufe der
...
// K-10/R1-15 (4T-000186): Render-Pane-Nachverarbeitung fuer Block-Widgets
...
// 4T-000355 (Epic 3E-000065): perspective-query-Befüllung im Live-Block-Widget
...
// 4T-000435 (Epic 3E-000081): Journal-Navigation im Live-Block-Widget
...
// 4T-001064 (Epic 3E-000212): Journal-Timeline-Block im Live-Widget befüllen.
import { applyJournalTimelineIfPresent } from '../calendar/journal-timeline-view.js';
// 4T-000412 (Epic 3E-000078): Skript-Blöcke im Live-Modus (Widget-Nachverarbeitung).
import { applyPerspectiveScriptsIfPresent } from '../query/perspective-script-view.js';
// 4T-000418 (Epic 3E-000079): Perspective-Datatable-Lokalisierung im Live-
...
// 4T-000512 (Epic 3E-000092): Ereignis-Fence im Live-Widget (Lokalisierung,
...
// 4T-000419 (Epic 3E-000079): Grid-Editor auch im Live-Widget (Laufzeit-
// Zugriffe im Handler, zyklenfest). 4T-000420: plus Ansichts-Zustand.
import {
...
//
// 4T-000198 (Epic 3E-000017): erweitert um opts {sourceText, standalone}.
...
// 4T-000084: Inline-Math-Widget. Ein `$x$`-Range wird inline durch das
...
// Dollar-Heuristik (4T-000022) und die Heuristik im Pre-Pass-Pattern hier
...
// 4T-000084: KaTeX-Block-Widget. Mehrzeiliger `$$…$$`-Block wird durch ein
...
// 4T-000084: Wiki-Embed-Widget. toDOM() schickt den `![[...]]`-Quelltext
...
// 4T-000088 (Epic 3E-000014): Generisches Block-Widget fuer Markdown-Inhalt,
...
export class MarkdownBlockWidget extends WidgetType {
  ...
  toDOM() {
    ...
    try {
      ...
      // dessen Clone.
      // 4T-000418: .perspective-datatable VOR table — der Wrapper (mit den
      // data-dt-Attributen fuer den Grid-Editor) liegt in Dokument-
      // Reihenfolge vor seiner inneren Tabelle und gewinnt damit.
      // 4T-000512 (Epic 3E-000092): .perspective-events ebenso VOR table —
  ...
  // K-10/R1-15 (4T-000186): Nachverarbeitung wie im Render-Pane (Copy-
